function [FAR] = PropTkoClb(W_S, P_W, Aircraft)
%
% PropTkoClb.m
...
% get the lift coefficient during climb (assume flaps extended)
...
% the required climb gradient is 8.3% --> use 5.5% for ~800 fpm climb
G = 0.055;
...
FAR = sqrt(W_S ./ CL) .* (G + 1 / L_D) ./ (18.97 * EtaPropeller) - P_W;
