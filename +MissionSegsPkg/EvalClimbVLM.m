function [Aircraft] = EvalClimbVLM(Aircraft)
%
...
%     fprintf(1, "Climb Iteration %2d:\n", iter);
    ...
    for i = 1:length(L)
      ...
      conditions.T = 1.5*DGuess; % (N) Thrust approximation at current condition, prefer to use value from drag at previous point, which will be close enough
