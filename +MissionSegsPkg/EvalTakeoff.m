...
% remember the power splits and windmilling
...
Aircraft.Mission.History.SI.Power.Windmill(SegBeg:SegEnd, :) = repmat(Aircraft.Specs.Power.Windmill.Tko, SegEnd - SegBeg + 1, 1);
