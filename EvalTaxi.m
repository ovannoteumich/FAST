...
%
% Evaluate taxi segement based on prescribed taxi time (must put at
% begining and end if want taxi-in and taxi-out
%
% INPUTS:
...
%
% OUTPUTS:
%     Aircraft - aircraft driven through taxi with the mission history
