function [Aircraft] = HW1VLM(Aircraft)
%
...
Mission.Target.Valu = [UnitConversionPkg.ConvLength([750; 150], "km", "m"); 30];
...
% define the segments
Mission.Segs = ["Takeoff"; "ClimbVLM"; "ClimbVLM"; "ClimbVLM"; "CruiseVLM"; "DescentVLM"; "DescentVLM"; "ClimbVLM"; "ClimbVLM"; "CruiseVLM"; "CruiseVLM"; "DescentVLM"; "DescentVLM"; "DescentVLM"; "Landing"];
...
Mission.ClbRate = [  NaN;   NaN;   NaN;   NaN;   NaN;   NaN;   NaN;   NaN;   NaN;   NaN;   NaN;   NaN;   NaN;   NaN;   NaN];
